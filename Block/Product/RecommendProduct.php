...
namespace FourTell\Recommend\Block\Product;
 ...
 *
 */
class RecommendProduct extends \Magento\Catalog\Block\Product\AbstractProduct implements
    \Magento\Framework\DataObject\IdentityInterface
{
     ...
     * @return Collection
     */
    protected function _getSearchResultProductCollection()
    {
        $productCollection = $this->getLayout()->getBlock('search_result_list')->getLoadedProductCollection();
